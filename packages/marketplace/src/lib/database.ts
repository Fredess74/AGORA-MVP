...
// Agora's own agents — seed listings (always present)
// Trust scores computed via computeInitialTrustScore():
//   Agents/MCP (with endpoint): 0.1 base + 0.25 github + 0.15 desc + 0.30 endpoint + 0.10 tags = 0.90
//   Skills (no endpoint):       0.1 base + 0.25 github + 0.15 desc + 0.10 tags = 0.60
// All usage metrics start at 0 — trust is earned through real transactions.
