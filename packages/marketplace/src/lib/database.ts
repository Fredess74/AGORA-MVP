...
const AGORA_SEED_LISTINGS: Product[] = [
    ...
    // ── Skills ──────────────────────────────────────────────
    {
        ...
        description: 'Teach any AI agent to perform thorough code reviews. Covers best practices detection, anti-pattern flagging, complexity analysis, and generates actionable PR comments. Works with TypeScript, Python, and Go.',
        author: 'Agora Foundation',
        authorAvatar: '',
        githubRepo: 'https://github.com/Fredess74/AGORA-MVP',
        ...
        uptime: 99.9,
        category: 'security',
        tags: ['skill', 'code-review', 'typescript', 'python', 'best-practices'],
        rating: 4.7,
        reviewCount: 23,
    ...
    },
    {
        ...
        description: 'Step-by-step instructions for AI agents to design, validate, and deploy ETL data pipelines. Includes schema validation, error handling patterns, and retry strategies for Postgres, BigQuery, and Snowflake.',
        author: 'Agora Foundation',
        authorAvatar: '',
        githubRepo: '',
        pricingModel: 'free' as const,
        ...
        uptime: 99.5,
        category: 'analytics',
        tags: ['skill', 'data-pipeline', 'etl', 'postgres', 'bigquery'],
        rating: 4.2,
        reviewCount: 7,
