...
export async function fetchPageSpeedFull(url: string): Promise<{ mobile: PageSpeedData; desktop: PageSpeedData }> {
...
export async function quickSiteCheck(url: string): Promise<{
    statusCode: number;
    redirects: boolean;
    hasSSL: boolean;
