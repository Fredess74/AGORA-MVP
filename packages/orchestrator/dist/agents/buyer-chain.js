...
JSON Schema:
{
  ...
  "constraints": string[] | null
    ...
    async formulate(directorQuery) {
        const { data, latencyMs } = await this.callJSON(directorQuery);
...
Respond in JSON:
{
  ...
  "recommendation": string ("accept" | "request_revision" | "reject")
    ...
    async validate(task, result) {
        ...
        const { data, latencyMs } = await this.callJSON(message);
        return {
...
//# sourceMappingURL=buyer-chain.js.map